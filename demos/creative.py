...
SETS = [
 {"id": "c1", "slug": "launch-video", "title": "Launch video",
  "goal": "Lumen is an analytics app for small teams. Here are five screenshots of it and a short clip of a presenter on a green screen. Make a launch video, 20 to 30 seconds, landscape, that makes someone want to try it. Everything else is your call: pacing, words, motion, looks.",
