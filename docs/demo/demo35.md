...
|---|---|
| turns | 32 |
| wall time | 4 min 04 s (API 3 min 58 s) |
| cost at API list price | $2.24 — on a Claude subscription this is plan usage, not a bill |
| tokens in | 1.9M (1.8M cache read, 83k cache write) |
| tokens out | 21k (6k thinking) |
| claude-haiku-4-5 | 2k in, 14 out, $0.00 |
| claude-opus-5 | 1.9M in, 21k out, $2.24 |
...
**[▶ Watch the video](https://github.com/garalex/promoshot/raw/demo-media/35-spiral-in.mp4)** (1280 wide, 1.1 MB) · [small copy](35-spiral-in/result.mp4) · [the project it wrote](35-spiral-in/result-metadata.json)
