...
|---|---|
| turns | 29 |
| wall time | 2 min 21 s (API 2 min 16 s) |
| cost at API list price | $1.63 — on a Claude subscription this is plan usage, not a bill |
| tokens in | 1.7M (1.7M cache read, 54k cache write) |
| tokens out | 10k (3k thinking) |
| claude-haiku-4-5 | 1k in, 12 out, $0.00 |
| claude-opus-5 | 1.7M in, 10k out, $1.63 |
...
**[▶ Watch the video](https://github.com/garalex/promoshot/raw/demo-media/29-bench.mp4)** (1280 wide, 0.3 MB) · [small copy](29-bench/result.mp4) · [the project it wrote](29-bench/result-metadata.json)
