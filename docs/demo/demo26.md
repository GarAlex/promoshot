...
| cost at API list price | $2.09 — on a Claude subscription this is plan usage, not a bill |
| tokens in | 2.3M (2.2M cache read, 69k cache write) |
| tokens out | 11k (4k thinking) |
| claude-haiku-4-5 | 1k in, 16 out, $0.00 |
| claude-opus-5 | 2.3M in, 11k out, $2.09 |
...
**[▶ Watch the video](https://github.com/garalex/promoshot/raw/demo-media/26-stage.mp4)** (1280 wide, 0.7 MB) · [small copy](26-stage/result.mp4) · [the project it wrote](26-stage/result-metadata.json)
