...
|---|---|
| turns | 36 |
| wall time | 2 min 46 s (API 2 min 39 s) |
| cost at API list price | $1.98 — on a Claude subscription this is plan usage, not a bill |
| tokens in | 2.3M (2.2M cache read, 55k cache write) |
| tokens out | 13k (3k thinking) |
| claude-haiku-4-5 | 2k in, 20 out, $0.00 |
| claude-opus-5 | 2.3M in, 13k out, $1.98 |
...
**[▶ Watch the video](https://github.com/garalex/promoshot/raw/demo-media/34-cube-to-word.mp4)** (1280 wide, 7.5 MB) · [small copy](34-cube-to-word/result.mp4) · [the project it wrote](34-cube-to-word/result-metadata.json)
