...
| <a href="docs/demo/demo25.md"><img src="docs/demo/25-turntable/thumb.png" width="160"></a> | [25 Turntable](docs/demo/demo25.md) | The built-in tablet body on a turntable, its body painted by the palette and a screenshot on its screen, beside extruded kinetic type. | [▶ watch](https://github.com/garalex/promoshot/raw/demo-media/25-turntable.mp4) · **100%** · 42 turns · 3 min 40 s · $1.98 · 2.1M in / 15k out · MCP 6 s in 12 calls |
