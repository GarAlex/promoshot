...
| <a href="docs/demo/demo25.md"><img src="docs/demo/25-turntable/thumb.png" width="160"></a> | [25 Turntable](docs/demo/demo25.md) | A generated phone model on a turntable, its body painted by the palette, beside extruded kinetic type. | [▶ watch](https://github.com/garalex/promoshot/raw/demo-media/25-turntable.mp4) · **100%** · 49 turns · 4 min 58 s · $2.63 · 2.8M in / 21k out · MCP 2 s in 10 calls |
