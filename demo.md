...
| <a href="docs/demo/demo25.md"><img src="docs/demo/25-turntable/thumb.png" width="160"></a> | [25 Turntable](docs/demo/demo25.md) | The built-in tablet body on a turntable, its body painted by the palette and a screenshot on its screen, beside extruded kinetic type. | [▶ watch](https://github.com/garalex/promoshot/raw/demo-media/25-turntable.mp4) · **100%** · 40 turns · 4 min 16 s · $2.38 · 2.4M in / 18k out · MCP 2 s in 14 calls |
